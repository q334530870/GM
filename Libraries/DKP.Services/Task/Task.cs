    ...
    public partial class Task
    {
        ...
        public void Execute(bool throwException = false, bool dispose = true)
        {
            ...
            try
            {
                ...
                if (task != null)
                {
                    this.LastStartUtc = DateTime.Now; //DateTime.UtcNow;
                    ...
                    //execute task
                    task.Execute();
                    this.LastEndUtc = this.LastSuccessUtc = DateTime.Now; //DateTime.UtcNow;
                }
            }
            catch (Exception exc)
            {
                this.Enabled = !this.StopOnError;
                this.LastEndUtc = DateTime.Now; //DateTime.UtcNow;
