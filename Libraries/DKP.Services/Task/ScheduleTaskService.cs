...
namespace DKP.Services.Task
{
    ...
    public partial class ScheduleTaskService : IScheduleTaskService
    {
        ...
        public IPagedList<ScheduleTask> GetTasks(NameValueCollection forms, PageParam pageParam)
        {
            var query = _taskRepository.Table.Where(forms.ResolveToLinq()).OrderBy(pageParam.ToString());
            return new PagedList<ScheduleTask>(query, pageParam);
        }
