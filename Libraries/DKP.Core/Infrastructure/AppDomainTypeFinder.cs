...
{
    /// <summary>
    /// A class that finds types needed by Papaya by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether Papaya should iterate assemblies in the app domain when loading Papaya types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Papaya assemblies arn't investigated (e.g. by not including something like "^Papaya|..." you may break core functionality.</remarks>
        ...
        public IEnumerable<Type> FindClassesOfType(Type assignTypeFrom, IEnumerable<Assembly> assemblies, bool onlyConcreteClasses = true)
        {
            ...
            catch (ReflectionTypeLoadException ex)
            {
                ...
                foreach (var e in ex.LoaderExceptions) { msg += e.Message + Environment.NewLine; }
        ...
        /// <returns>A list of assemblies that should be loaded by the Papaya factory.</returns>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Papaya.
        /// </returns>
