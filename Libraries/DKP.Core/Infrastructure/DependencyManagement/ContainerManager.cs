...
namespace DKP.Core.Infrastructure.DependencyManagement
{
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new PapayaException("Unkown dependency");
                        parameterInstances.Add(service);
                    }
                    return Activator.CreateInstance(type, parameterInstances.ToArray());
                }
                catch (PapayaException)
                {

                }
            }
            throw new PapayaException("No contructor was found that had all the dependencies satisfied.");
        }
